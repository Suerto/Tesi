...
\begin{itemize}
    ...
    \item I termini contrassegnati dal simbolo $^{G}$ in apice sono definiti al glossario in appendice. Alla prima occorrenza, il termine è accompagnato da una breve definizione contestuale; nelle occorrenze successive, il simbolo $^{G}$ permette un rimando diretto alla definizione completa.
\end{itemize}
\endgroup
\vfill
